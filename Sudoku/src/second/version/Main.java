...
public class Main
{
        ...
        while (!solutionTrouvee && duration < 600){
            ...
            for(int i=0; i<plateauItere.length; i++) {
                for(int j=0; j<plateauItere[i].length; j++) {
                    ...
                    if(0 == plateauItere[i][j].getChiffreValide()){
    ...
    public static boolean isSudokuComplete(){
        ...
        while(compteurVertical< HAUTEUR_COTE * HAUTEUR_COTE){
            while(compteurHorizontal< LARGEUR_COTE * LARGEUR_COTE){
    ...
    public static void initialisationTableau(){
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(0, 0, 5);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(0, 1, 3);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(0, 4, 7);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(1, 0, 6);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(1, 3, 1);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(1, 4, 9);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(1, 5, 5);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(2, 1, 9);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(2, 2, 8);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(2, 7, 6);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(3, 0, 8);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(3, 4, 6);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(3, 8, 3);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(4, 0, 4);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(4, 3, 8);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(4, 5, 3);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(4, 8, 1);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(5, 0, 7);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(5, 4, 2);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(5, 8, 6);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(6, 1, 6);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(6, 6, 2);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(6, 7, 8);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(7, 3, 4);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(7, 4, 1);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(7, 5, 9);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(7, 8, 5);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(8, 4, 8);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(8, 7, 7);
        ...
        SupprUtilities.supprimerChiffrePossibleDeZone(8, 8, 9);
