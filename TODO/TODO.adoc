...
But du jeu : une Némésis est désigné pour la personne joueuse, il doit l'amener au SdM. Si quelqu'un d'autre que lui l'amène au SdM, il devra alors amener au SdM ce quelqu'un en question.
