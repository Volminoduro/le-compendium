...
** Les blessures de combat que vous infligez ne peuvent être soignés - [Baisse les PVS max ?].
** Peut être ciblé par un adversaire pour subir les conséquences d'un combat à votre place.
