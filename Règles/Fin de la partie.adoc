- La partie se termine lorsque'un personnage a accompli sa quête. Si cela arrive durant le tour d'un joueur, celui-ci a le droit de terminer son tour normalement.
