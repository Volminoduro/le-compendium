- Pour avancer, vous devez lancer le dé à 4 faces et celui à 3 faces. Vous additionnez le résultat de ces dés et vous pouvez avancer d'autant de cases que le résultat.
