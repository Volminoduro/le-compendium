- Les points s'additionnent et se soustraient les un aux autres pour former un total. Ce total formera votre total de point qui servira à déterminer le classement à la fin de la partie.
