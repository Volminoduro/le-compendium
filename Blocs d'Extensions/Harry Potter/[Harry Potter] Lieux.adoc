...
** L'accès à ce Lieu vous sera interdit jusqu'à la fin de la partie.
...
* Lancez les dés :
** *2 - Colonie d'Aragog :* si vous n'êtes pas _Aragog_, attaquer à plus de 3 3 fois. Subissez une blessure ou un _Equipement_, par échec.
...
* *Rencontre avec les rafleurs :* en commençant par le _Personnage_ qui a découvert ce lieu puis selon l'ordre de jeu, chaque _Personnage_ doit se défendre contre un groupe de rafleurs, si la défense est inférieure à 4, il perds une carte aléatoirement (de votre main ou de vos _Equipement_s).
