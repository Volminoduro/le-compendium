...
=== http://harrypotter.wikia.com/wiki/Fenrir_Greyback[Fenrir Greyback (0.90 - TODO - Effets)]
  ...
  * *Chef des rafleurs :* se rapprocher d'une cible, la racketter, gagner des golds en cas de capture ?.
...
=== [Bellastrix Lestrange (0.10 - TODO)]
